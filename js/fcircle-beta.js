    ...
    for (var i = 0;i<nextArticle.length;i++){
      ...
      <div class="cf-article">
        ...
        <div class="cf-article-avatar no-lightbox flink-item-icon">
          ...
          <span class="cf-article-author">${item.author}</span>
          <span class="cf-article-time">
            <span class="cf-time-created" style="${sortNow == 'created' ? '':'display:none'}"><i class="far fa-calendar-alt"></i>${item.created}</span>
            <span class="cf-time-updated" style="${sortNow == 'updated' ? '':'display:none'}"><i class="fas fa-history"></i>${item.updated}</span>
          </span>
        </div>
      </div>
      `;
